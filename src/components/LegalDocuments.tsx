    ...
    return (
        <Dialog>
            ...
            <DialogContent className="max-w-[800px] max-h-[80vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>Termos de Serviço - Finzap</DialogTitle>
                ...
                <div className="space-y-4 text-sm text-foreground/80">
                    <p>
                        Bem-vindo ao Finzap. Ao acessar ou usar nosso sistema, você concorda em cumprir estes Termos de Serviço.

                    </p>

                    <h3 className="text-lg font-semibold text-foreground">1. Uso do Sistema</h3>
                    <p>
                        O Finzap é uma ferramenta de gestão financeira destinada exclusivamente ao uso interno. O acesso é restrito a pessoal autorizado.
...
export function PrivacyPolicyDialog() {
    return (
        <Dialog>
            ...
            <DialogContent className="max-w-[800px] max-h-[80vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>Política de Privacidade - Finzap</DialogTitle>
                ...
                <div className="space-y-4 text-sm text-foreground/80">
                    <p>
                        A sua privacidade é importante para nós. Esta política descreve como o Finzap coleta, usa e protege suas informações.
